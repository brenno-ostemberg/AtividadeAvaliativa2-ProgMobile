...
public class ListaJogadoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoVoltarMainJogadores.setOnClickListener(v -> {
            ...
            startActivity(intent);
            finish(); // Opcional: finalizar esta activity se não quiser que ela fique na pilha
        });
    ...
    // É uma boa prática desligar o ExecutorService quando a Activity é destruída
    @Override
